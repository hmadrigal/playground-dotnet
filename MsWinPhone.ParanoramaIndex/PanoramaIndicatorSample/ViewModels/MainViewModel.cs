...
using SamplePanoramaApp.Resources;
using System.Collections.Generic;

namespace SamplePanoramaApp.ViewModels
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public ReadOnlyObservableCollection<string> PanoramaItems
        {
            get { return _panoramaItems; }
        }
        private readonly ReadOnlyObservableCollection<string> _panoramaItems = new ReadOnlyObservableCollection<string>(new ObservableCollection<string>() { "1", "2", "3" });
