...
LOGICAL_OR_OPERATOR:
    '||' { setType(isSqlModeActive(SqlMode.PipesAsConcat) ? CONCAT_PIPES_SYMBOL : LOGICAL_OR_OPERATOR); }
;
BITWISE_OR_OPERATOR: '|';
...
CHANNEL_SYMBOL:                  C H A N N E L                               {serverVersion >= 50706}?;
...
COLUMN_FORMAT_SYMBOL:
    C O L U M N '_' F O R M A T                                              {serverVersion >= 50600}?
;                                                                            // Said to be available only in MySQL cluster, but nonetheless handled in the standard server parserserver well.
...
FILTER_SYMBOL:                   F I L T E R                                 {serverVersion >= 50700}?;
...
IO_AFTER_GTIDS_SYMBOL:
    I O '_' A F T E R '_' G T I D S                                          {serverVersion >= 50600}?
;                                                                            // MYSQL, FUTURE-USE
IO_BEFORE_GTIDS_SYMBOL:
    I O '_' B E F O R E '_' G T I D S                                        {serverVersion >= 50600}?
;                                                                            // MYSQL, FUTURE-USE
...
MASTER_DELAY_SYMBOL:             M A S T E R '_' D E L A Y                   {serverVersion >= 50600}?;
...
MASTER_SSL_CRL_SYMBOL:           M A S T E R '_' S S L '_' C R L             {serverVersion >= 50603}?;
...
NEG_SYMBOL:                      N E G;
NEVER_SYMBOL:                    N E V E R                                   {serverVersion >= 50704}?;
...
NOT_SYMBOL:
    N O T                                                                    { setType(isSqlModeActive(SqlMode.HighNotPrecedence) ? NOT2_SYMBOL: NOT_SYMBOL); }
;                                                                            // SQL-2003-R
...
OLD_PASSWORD_SYMBOL:             O L D '_' P A S S W O R D                   {serverVersion < 50706}?;
ON_SYMBOL:                       O N;                                        // SQL-2003-R
ONE_SHOT_SYMBOL:                 O N E '_' S H O T                           {serverVersion < 50600}?; // Deprecated in 5.0, removed in 5.6.
ONE_SYMBOL:                      O N E;
ONLINE_SYMBOL:                   O N L I N E;
ONLY_SYMBOL:                     O N L Y                                     {serverVersion >= 50605}?;
OPEN_SYMBOL:                     O P E N;                                    // SQL-2003-R
OPTIMIZE_SYMBOL:                 O P T I M I Z E;
OPTIMIZER_COSTS_SYMBOL:          O P T I M I Z E R '_' C O S T S             {serverVersion >= 50706}?;
...
REPLICATE_IGNORE_DB_SYMBOL:      R E P L I C A T E '_' I G N O R E '_' D B   {serverVersion >= 50700}?;
REPLICATE_DO_TABLE_SYMBOL:       R E P L I C A T E '_' D O '_' T A B L E     {serverVersion >= 50700}?;
REPLICATE_IGNORE_TABLE_SYMBOL:
    R E P L I C A T E '_' I G N O R E '_' T A B L E                          {serverVersion >= 50700}?
;
REPLICATE_WILD_DO_TABLE_SYMBOL:
    R E P L I C A T E '_' W I L D '_' D O '_' T A B L E                      {serverVersion >= 50700}?
;
...
ROTATE_SYMBOL:                   R O T A T E                                 {serverVersion >= 50713}?;
...
STATS_AUTO_RECALC_SYMBOL:        S T A T S '_' A U T O '_' R E C A L C       {serverVersion >= 50600}?;
STATS_PERSISTENT_SYMBOL:         S T A T S '_' P E R S I S T E N T           {serverVersion >= 50600}?;
